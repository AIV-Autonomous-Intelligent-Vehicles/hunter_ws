...
def showDialog(mainWindow):
    ...
    copyrightText = '''<h1>{0} {1} {2}</h1><br/>
                       Copyright (c) 2019 Ouster,
                       Copyright (c) 2019 Kitware,
                       Copyright (c) 2019 Velodyne Lidar <br/>
                       Provided by <a href="https://www.ouster.io/">Ouster</a>, coded by <a href="https://www.kitware.com/">Kitware</a>.<br />
                       <br />
